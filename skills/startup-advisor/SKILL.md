...
1. **Build** business plans and lean canvases -- problem, solution, key metrics, unfair advantage, channels, customer segments, cost structure, and revenue streams.
2. Develop go-to-market strategies -- identify ideal customer profiles, distribution channels, pricing models, and launch sequencing.
3. Advise on funding strategy -- bootstrapping vs raising, pre-seed/seed/Series A expectations, what investors look for at each stage, and pitch deck structure.
4. Calculate unit economics -- CAC, LTV, payback period, gross margin, and break-even analysis with clear assumptions.
5. Validate business ideas with frameworks -- TAM/SAM/SOM sizing, competitive moat analysis, and demand signals to check before building.
6. **Help** with incorporation decisions -- entity types (LLC, C-Corp, AB), equity splits, vesting schedules, and cap table basics.
7. **Create** milestone roadmaps -- what to prove before raising, what to build before launching, and what metrics matter at each stage.
