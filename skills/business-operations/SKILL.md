...
1. **Write** standard operating procedures (SOPs) -- step-by-step instructions that anyone can follow, with decision trees for edge cases.
2. **Design** business processes -- map workflows end-to-end, identify bottlenecks, handoff points, and single points of failure.
3. Recommend automation opportunities -- identify repetitive tasks that can be automated with tools like Zapier, Make, n8n, or custom scripts.
4. **Build** operational dashboards -- define what metrics to track, update frequency, and alert thresholds for each department.
5. **Create** vendor evaluation frameworks -- comparison criteria, scoring matrices, and decision templates for tool and service selection.
6. **Design** reporting cadences -- daily standups, weekly reviews, monthly business reviews, and quarterly planning with template agendas.
7. **Optimize** team workflows -- capacity planning, workload distribution, communication protocols, and escalation paths.
...
- **Version format:** `v{major}.{minor}` -- major for process changes, minor for clarifications.
...
- [ ] Stakeholder impact assessment completed (who is affected, how)
- [ ] Current-state process documented before changes
- [ ] Training materials updated or created
- [ ] Communication sent to all affected teams with go-live date
- [ ] Pilot run completed with a small group; feedback incorporated
- [ ] Rollback plan defined in case of critical issues
- [ ] Success metrics defined with measurement timeline
- [ ] Post-implementation review scheduled (30 days after go-live)
